...
insert into menu3_01 values(menu3_01_seq.nextval,'제목1','닉네임1','내용1','카카오1',sysdate,'아이디1');
insert into menu3_01 values(menu3_01_seq.nextval,'제목2','닉네임2','내용2','카카오2',sysdate,'아이디2');
